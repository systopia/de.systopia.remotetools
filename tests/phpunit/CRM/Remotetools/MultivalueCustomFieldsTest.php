...
class CRM_Remotetools_MultivalueCustomFieldsTest extends CRM_Remotetools_RemoteContactTestBase {
  ...
  public function testMultiValueCustomOR() {
    ...
    static::assertCount(2, $contacts, 'This should have found both contacts');
    $contacts = $this->remoteContactQuery($profile, [
    ...
    static::assertCount(1, $contacts, 'This should have found only one contact');
    $contacts = $this->remoteContactQuery($profile, [
    ...
    static::assertCount(0, $contacts, 'This should have NOT found both contacts, because the API does AND');
    $contacts = $this->remoteContactQuery($profile, [
    ...
    static::assertCount(2, $contacts, 'This should have found both contacts, because the API was instructed to OR');
